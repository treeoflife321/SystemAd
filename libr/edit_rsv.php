...
if(isset($_GET['rid'])) {
    ...
    if ($result && $result->num_rows > 0) {
        ...
        header("Location: admin_wrel.php?aid=$aid");
        exit;
    }
    // Close statement
    $stmt->close();
    ...
    <div class="form-container">
        ...
        <form id="editForm" method="POST" action=""> <!-- Updated action to the same file -->
            ...
            <div class="button-container">
                ...
                <a href="admin_wrel.php?aid=<?php echo $aid; ?>"><button style="width: 100px; background-color:red;" type="button">Cancel</button></a>
        ...
        .then(data => {
            if (data.success) {
                Swal.fire({
                    ...
                    window.location.href = "admin_wrel.php?aid=<?php echo $aid; ?>";
                });
            } else {
                Swal.fire({
                    icon: 'error',
