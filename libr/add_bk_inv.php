    ...
    <div class="content-container">
        ...
        <div class="form-container">
            ...
            <form action="add_bk_inv.php<?php if(isset($aid)) echo '?aid=' . $aid; ?>" method="POST">
                ...
                <input type="text" id="added_by" name="added_by" placeholder="Enter who added the book" required value="<?php echo htmlspecialchars($admin_username); ?>" readonly>

                <div class="button-container">
                    <a href="bk_inv.php<?php if(isset($aid)) echo '?aid=' . $aid; ?>"><button type="button">Cancel</button></a>
